...
export function SampleChopperPanel() {
  ...
  return (
    <section className="rounded-lg border border-amber-500/25 bg-gradient-to-b from-amber-500/10 to-[#0d0d14] p-3">
      <p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-amber-300">
        Kanye Sample Chopper
      </p>
      <p className="mt-1 text-xs leading-relaxed text-zinc-300">
        Slice, flip, and repitch soul samples — place chops on the timeline at the playhead.
      </p>
      ...
      >
        Place chop {selectedSlice + 1} at playhead
      </button>
    </section>
  );
}
